...
class HeaderData {
  ...
  ///highlight header that will be placed on the header,  this widget always be
  ///visible without blurring effect
...
class HeaderClipper extends CustomClipper<Rect> {
  ...
  @override
  Rect getClip(Size size) => Rect.fromLTRB(0, 0, size.width, height);
